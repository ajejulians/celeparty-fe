...
export default function CreateBlogPage() {
	...
	const onSubmit = async (_data: BlogFormValues) => {
				...
				<div className="flex items-center gap-4 mb-8">
					...
					<div>
						...
						<p className="font-sans text-sm text-neutral-500 mt-1">
							Buat konten menarik untuk pengguna
						</p>
					</div>
				</div>
						...
						<Card>
							...
							<CardContent className="space-y-6">
								<div className="space-y-2">
									...
									<Input
										{...register("title")}
										placeholder="Contoh: 5 Tips Memilih Vendor Dokumentasi"
								...
								<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
									...
									<div className="space-y-2">
										<Label className="font-sans text-neutral-700">
											Tautan Produk/Tiket Terkait (Opsional)
										</Label>
										<Input
											{...register("relatedProducts")}
											placeholder="Contoh: PD-001, TC-002"
											className="font-sans text-base h-11"
										/>
							...
							<CardFooter className="bg-neutral-50 border-t border-neutral-100 flex justify-end gap-3 rounded-b-lg">
								...
								<Button
									...
									className="bg-c-blue text-white font-quick font-semibold h-11 px-6 hover:brightness-95"
								>
