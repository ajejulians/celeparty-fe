      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg border border-neutral-200">
          <div className="flex flex-col sm:flex-row gap-3 p-4 items-start sm:items-center justify-between border-b border-neutral-100">
            <div className="flex gap-2"><div className="relative"><Search className="w-4 h-4 absolute left-3 top-2.5 text-neutral-400"/><input placeholder="Cari pesanan..." className="pl-9 pr-3 py-2 text-sm border rounded-lg w-56 font-sans focus:outline-none focus:border-c-blue" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} /></div><select className="text-sm border rounded-lg px-3 py-2 font-sans"><option>Semua Status</option></select></div>
