...
import { CheckCircle, ExternalLink, Search, X, XCircle } from "lucide-react";
...
const mockPendingItems = [
	{
		id: "prd-001",
		type: "product",
		name: "Sewa Videotron 3x4m Indoor",
		vendor: "Visual Pro JKT",
	...
	},
	{
		id: "tkt-001",
		type: "ticket",
		name: "Konser Musik Indie Fest",
		vendor: "Eventku Nusantara",
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
				<div className="mb-8">
					...
					<p className="font-sans text-sm text-neutral-500 mt-1">
						Review produk dan tiket baru yang didaftarkan oleh vendor
					</p>
				</div>
								...
								{filteredItems.map((item, i) => (
									...
									>
										<td className="px-4 py-3">
											<span
												className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-semibold font-quick border ${
													item.type === "product"
														? "bg-blue-50 text-c-blue border-blue-200"
										...
										<td className="px-4 py-3 font-sans text-sm text-neutral-900 font-medium">
											{item.name}
										</td>
										...
										<td className="px-4 py-3 text-center">
											<span
												className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold font-sans border ${
													item.status === "pending"
										...
										<td className="px-4 py-3">
											{item.status === "pending" ? (
												<div className="flex items-center justify-center gap-2">
													<button
														className="p-1.5 rounded-md text-neutral-500 hover:bg-neutral-100 hover:text-c-blue"
														title="Lihat Detail"
													>
													...
													<button
														...
														className="p-1.5 rounded-md text-c-red hover:bg-red-50"
														title="Tolak"
													>
												...
												<div className="text-center text-xs font-sans text-neutral-400">
													Selesai
												</div>
											)}
										</td>
							...
							<div className="flex justify-end gap-3">
								<Dialog.Close asChild>
									<Button
										type="button"
										variant="outline"
										className="font-quick font-semibold h-11"
									>
										Batal
									</Button>
								</Dialog.Close>
								<Button
									type="submit"
									className="h-11 font-quick font-semibold bg-c-red text-white hover:brightness-95"
								>
