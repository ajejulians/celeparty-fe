...
import { events, EventData } from "@/lib/data";
...
const allCategories = ["Semua", ...Array.from(new Set(events.map((e) => e.category)))];
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-4">
                ...
                <div className="pt-4 border-t border-neutral-100 flex items-center justify-between">
                  <div>
                    <p className="text-[11px] text-neutral-400 uppercase tracking-wider font-semibold mb-0.5">Mulai dari</p>
