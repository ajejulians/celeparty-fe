    ...
    <div className="bg-neutral-50 pb-20">
      <div className="bg-white border-b border-neutral-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link href="/events" className="inline-flex items-center gap-2 text-sm font-sans text-neutral-500 hover:text-c-blue transition-colors">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-lg border border-neutral-100 group">
              ...
              <div className="absolute top-5 left-5 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full shadow-sm">
                <p className="text-sm font-quick font-bold text-c-blue">{event.category}</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-neutral-200">
              ...
              <div className="prose prose-neutral max-w-none font-sans text-neutral-600 leading-relaxed text-lg">
                <h3 className="font-quick font-bold text-2xl text-neutral-900 mb-4">Deskripsi Event</h3>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col justify-center">
                    <p className="text-xs font-sans text-neutral-500 mb-1 uppercase tracking-wide font-semibold">Tanggal</p>
                    <p className="font-quick font-bold text-neutral-900">{formatDate(event.date)}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col justify-center">
                    <p className="text-xs font-sans text-neutral-500 mb-1 uppercase tracking-wide font-semibold">Waktu</p>
                    <p className="font-quick font-bold text-neutral-900">{event.time}</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col justify-center">
                    <p className="text-xs font-sans text-neutral-500 mb-1 uppercase tracking-wide font-semibold">Lokasi</p>
                    <p className="font-quick font-bold text-neutral-900">{event.location}</p>
                  </div>
                </div>
              </div>

              <div className="bg-neutral-50 rounded-2xl p-5 mb-8 border border-neutral-100">
                <p className="text-xs font-sans text-neutral-500 mb-1 uppercase tracking-wide font-semibold">Penyelenggara</p>
                <p className="font-quick font-bold text-lg text-neutral-900">{event.organizer}</p>
              </div>

              <div className="border-t border-neutral-100 pt-8">
                <p className="text-sm font-sans text-neutral-500 mb-2 font-semibold">Harga Tiket Mulai Dari</p>
