...
const categories = [
	{
		...
		href: "/products?category=Audio+%26+Sound",
		description: "Sound system, lighting, dan band untuk event Anda",
		size: "lg",
	},
	{
		name: "Kuliner",
		...
		description: "Catering dan hidangan terbaik",
		size: "sm",
	},
	{
		name: "Seni & Dekorasi",
		icon: <Palette className="w-8 h-8" />,
		href: "/products?category=Dekorasi",
		description: "Dekorasi dan tata rias profesional",
		size: "sm",
	},
	{
		name: "Fotografi",
		icon: <Star className="w-8 h-8" />,
		href: "/products?category=Fotografi",
		description: "Foto, video, dan dokumentasi cinematic",
		size: "sm",
	},
];
...
const testimonials = [
	{
		...
		type: "Pernikahan",
		review:
			"Sangat membantu menemukan vendor dekorasi dan sound system profesional. Transaksi aman dan kualitas terjamin!",
		rating: 5,
	},
	{
		name: "Budi Tabuti",
		...
		review:
			"Pesan catering untuk acara kantor jadi sangat mudah. Prosesnya cepat dan customer service sangat responsif 24/7.",
		rating: 5,
	},
	{
		name: "Diana Putri",
		type: "Ulang Tahun",
		review:
			"Koleksi fotografer di Celeparty luar biasa. Saya bisa dengan mudah membandingkan portofolio sebelum memilih.",
		rating: 4,
	},
	{
		name: "Rizki Pratama",
		type: "Music Festival",
		review:
			"Booking sound system dan lighting gampang banget. Kualitas alat top, teknisi profesional, acara lancar tanpa kendala.",
		rating: 5,
	},
	{
		name: "Maya Indah",
		type: "Wedding",
		review:
			"Dekorasi pernikahan persis seperti yang saya bayangkan. Tim Celeparty membantu dari awal sampai hari-H.",
		rating: 5,
	},
];
							...
							>
								<Link href="/products">
									<Button
										variant="cta"
										size="lg"
										className="shadow-lg shadow-c-green/20"
									>
								...
								{isVendorOrAdmin && (
									<Link href="/user/vendor/dashboard">
										<Button
											variant="outline"
											size="lg"
											className="bg-white text-purple-700 hover:bg-gray-100 border-white/30"
										>
											Buat Event
										</Button>
									</Link>
			...
			<FadeInSection>
				<section className="bg-slate-50 py-24">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
						<h2 className="font-quick font-bold text-3xl md:text-4xl text-neutral-900 mb-4">
							Mengapa Memilih Celeparty?
						</h2>
						<p className="font-sans text-base text-neutral-500 max-w-2xl mx-auto mb-16">
							Platform terpercaya yang menghubungkan Anda dengan ribuan vendor
							profesional di seluruh Indonesia. Dari perencanaan hingga
							pelaksanaan, kami ada untuk Anda.
						</p>
							...
							{[
								{
									...
									desc: "Pembayaran dijamin aman dengan sistem escrow terintegrasi.",
									color: "bg-emerald-50 text-emerald-600",
								},
								{
									icon: <Star className="w-8 h-8" />,
									title: "Kualitas Terjamin",
									desc: "Vendor yang telah dikurasi dengan ulasan pelanggan asli yang valid.",
									color: "bg-c-blue-50 text-c-blue",
								},
								{
									icon: <Headphones className="w-8 h-8" />,
									title: "Dukungan 24/7",
									desc: "Tim support kami siap membantu Anda kapan saja tanpa henti.",
								...
								<StaggerItem key={i}>
									<div className="bg-white rounded-3xl p-8 border border-neutral-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
										<div
											className={`w-16 h-16 ${feature.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300`}
										>
											{feature.icon}
										</div>
										<h3 className="font-quick font-bold text-xl text-neutral-900 mb-3">
											{feature.title}
										</h3>
											...
											<div className="bg-slate-50 rounded-3xl p-8 border border-neutral-100 relative h-full">
												...
												<div className="flex gap-1 mb-6">
													{Array.from({ length: 5 }).map((_, i) => (
														<Star
															key={i}
															className={`w-5 h-5 ${i < t.rating ? "text-c-orange fill-c-orange" : "text-neutral-300"}`}
														/>
													))}
												</div>
				...
				<section className="bg-slate-50 py-24 border-t border-neutral-100">
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						<div className="text-center mb-12">
							...
							<p className="font-sans text-base text-neutral-500">
								Jelajahi vendor terpercaya dengan rating terbaik dari customer
								kami.
							</p>
						</div>

						<div
							className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-8 pt-4 px-4 -mx-4"
