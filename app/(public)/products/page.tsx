...
const priceRanges = [
  { label: "Di bawah Rp 5.000.000", value: "under5m", test: (p: Product) => p.priceFrom < 5_000_000 },
  { label: "Rp 5.000.000 – Rp 10.000.000", value: "5to10m", test: (p: Product) => p.priceFrom >= 5_000_000 && p.priceFrom <= 10_000_000 },
  { label: "Di atas Rp 10.000.000", value: "above10m", test: (p: Product) => p.priceFrom > 10_000_000 },
];
...
export default function ProductsPage() {
  ...
  const activeFilterCount = selectedCategories.length + selectedCities.length + (priceRange ? 1 : 0);
        ...
        <aside className="hidden lg:block w-64 shrink-0 sticky top-24 self-start">
          <div className="bg-white rounded-xl border border-neutral-200 p-5">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-quick font-bold text-sm text-neutral-900">Filter</h3>
              {activeFilterCount > 0 && (
                <button
            ...
            <Accordion type="multiple" defaultValue={["categories", "cities", "prices"]}>
