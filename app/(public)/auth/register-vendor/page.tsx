		...
		return (
			<div className="min-h-[calc(100vh-64px)] bg-neutral-50 flex items-center justify-center px-4 py-12">
				<div className="max-w-md w-full bg-white rounded-2xl p-8 text-center shadow-sm border border-neutral-100">
					...
					<h2 className="font-quick font-bold text-2xl text-neutral-900 mb-3">
						Pengajuan Berhasil!
					</h2>
					<p className="font-sans text-neutral-500 mb-8">
						Terima kasih telah mendaftar sebagai vendor di Celeparty. Tim kami
			...
			<div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="bg-white rounded-2xl border border-neutral-100 shadow-sm overflow-hidden">
					<div className="bg-c-blue p-8 text-center">
						...
						<h1 className="font-quick font-bold text-3xl text-white mb-2">
							Mulai Perjalanan Anda
						</h1>
						<p className="font-sans text-white/80">
							Bergabunglah menjadi vendor Celeparty dan jangkau lebih banyak
							pelanggan.
						</p>
					</div>
