...
import { Eye, EyeOff, User, Store, Smartphone, Check } from "lucide-react";
              ...
              {role === "vendor" && (
                <div className="motion-safe:animate-fade-in motion-reduce:animate-none">
                  <FormField
                    ...
                    onChange={(v) => {
                      setStoreName(v);
                      if (errors.storeName) setErrors((e) => ({ ...e, storeName: "" }));
                    }}
                ...
                <label className="flex items-start gap-2 cursor-pointer select-none">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (errors.agreeTerms) setErrors((e) => ({ ...e, agreeTerms: "" }));
                    }}
