      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="space-y-4">
            <h2 className="font-quick text-3xl md:text-4xl font-bold text-c-blue">Mari Terhubung</h2>
            <p className="text-neutral-600 font-sans text-base leading-relaxed">
              Punya pertanyaan tentang paket event atau ingin berkolaborasi? Tim kami siap membantu mewujudkan perayaan impian Anda dengan profesionalisme tinggi.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 p-4 rounded-xl bg-white shadow-sm border border-neutral-200 hover:border-c-blue transition-colors">
              ...
              <div>
                <h4 className="font-quick font-semibold text-c-blue text-base">Kantor Pusat</h4>
                <p className="text-neutral-500 font-sans text-sm mt-1">Jl. Festive No. 42, Kebayoran Baru, Jakarta Selatan, 12150</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-4 rounded-xl bg-white shadow-sm border border-neutral-200 hover:border-c-blue transition-colors">
              ...
              <div>
                <h4 className="font-quick font-semibold text-c-blue text-base">Email Dukungan</h4>
                <p className="text-neutral-500 font-sans text-sm mt-1">halo@celeparty.com</p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-4 rounded-xl bg-white shadow-sm border border-neutral-200 hover:border-c-blue transition-colors">
              ...
              <div>
                <h4 className="font-quick font-semibold text-c-blue text-base">WhatsApp Business</h4>
                <p className="text-neutral-500 font-sans text-sm mt-1">+62 812-3456-7890</p>
              </div>
            </div>
          </div>
          
          <div className="pt-6">
            <h4 className="font-quick font-semibold text-c-blue text-base mb-4">Ikuti Kami</h4>
            <div className="flex gap-4">
              <a className="w-10 h-10 rounded-full bg-c-blue flex items-center justify-center text-white hover:scale-105 transition-transform" href="#">
          ...
          <div className="relative w-full h-48 rounded-2xl overflow-hidden shadow-inner bg-neutral-200 group">
            <div 
              ...
              style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuD2Z-HqZG3SgVexaWNXeTCB1UVxCgXocbRR6BXkPXhhvdujwsg7tLZ96UDVq0hd4UlOiANnuhn-3DiF4X0lOSngZNIwos3X3AD-qdF51yfVtiykW1KP7LAlyMo08E8YzB4t3Os8KrkIoJL4GQayIo3MCsAg8ABMbQTbDmr0t9RWvXw7xOvAc8NWgd-pz3_RvC2dTZt9LUiRNLDXbrNcSwWQY3y5GaNbrTNDVKIiAnzWmhhTlDWGuD5qv3M1rDu9Yl7fsKNo1QT8zfx_')" }}
            >
            </div>
        ...
        <div className="lg:col-span-7 bg-white p-8 md:p-12 rounded-3xl shadow-card border border-neutral-100 relative overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-32 h-32 opacity-5 pointer-events-none">
            <svg className="text-c-blue" fill="currentColor" viewBox="0 0 100 100">
          ...
          <div className="relative z-10 space-y-8">
            <header>
              <h3 className="font-quick text-2xl font-bold text-c-blue">Kirim Pesan</h3>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="font-sans text-sm font-medium text-neutral-900 flex items-center gap-1" htmlFor="name">
                ...
                {/* Email */}
                <div className="space-y-2">
                  <label className="font-sans text-sm font-medium text-neutral-900 flex items-center gap-1" htmlFor="email">
              ...
              {/* Subject */}
              <div className="space-y-2">
                <label className="font-sans text-sm font-medium text-neutral-900 flex items-center gap-1" htmlFor="subject">
              ...
              {/* Message */}
              <div className="space-y-2">
                <label className="font-sans text-sm font-medium text-neutral-900 flex items-center gap-1" htmlFor="message">
