...
export default function VendorDashboardV2Page() {
	...
	const pendingCount = vendorOrders.filter(
		(o) => o.paymentStatus === "pending" || o.paymentStatus === "dp_pending",
	).length;
	const totalRevenue = vendorOrders
		...
		.reduce(
			(acc, order) =>
				acc +
				(order.paymentStatus === "dp_paid" ? order.dpAmount : order.total),
			0,
		);
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="font-sans text-sm text-neutral-500 mt-1">
							Selamat datang kembali, Jakarta Audio Pro &#x2014; berikut
					...
					<Card className="md:col-span-3">
						<CardHeader>
							...
							<CardDescription>
								...
								<a
									href="/user/vendor/orders"
									className="text-c-blue hover:underline font-medium"
								>
									Lihat semua
								</a>
							</CardDescription>
