...
import { CreditCard, Save, Store } from "lucide-react";
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
				<div className="mb-8">
					...
					<p className="font-sans text-sm text-neutral-500 mt-1">
						Kelola informasi toko dan rekening bank Anda
					</p>
				</div>
				<div className="space-y-6">
					<div className="bg-white rounded-lg border border-neutral-200 p-6">
						<div className="flex items-center gap-3 mb-6">
							<Store className="w-5 h-5 text-c-blue" />
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
							<div className="flex flex-col gap-1.5">
								...
								<input
									...
									className="w-full px-3 py-2.5 h-11 border border-neutral-200 rounded-lg bg-white font-sans text-base focus:outline-none focus:border-c-blue focus:ring-2 focus:ring-c-blue/15"
								/>
							</div>
							<div className="flex flex-col gap-1.5">
								<label className="text-sm font-sans font-medium text-neutral-700">
					...
					<div className="bg-white rounded-lg border border-neutral-200 p-6">
						<div className="flex items-center gap-3 mb-6">
							<CreditCard className="w-5 h-5 text-c-blue" />
							<h2 className="font-quick font-bold text-lg text-neutral-900">
								Informasi Rekening
							</h2>
						</div>
					...
					<button
						onClick={handleSave}
						className="inline-flex items-center gap-2 bg-c-blue text-white font-quick font-semibold text-sm px-6 py-3 rounded-lg min-h-[44px] hover:bg-c-blue/90 active:scale-[0.98] transition-all"
					>
