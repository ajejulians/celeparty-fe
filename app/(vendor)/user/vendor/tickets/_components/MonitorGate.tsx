...
import type { VendorEvent } from "@/lib/ticket-data";
	...
	return (
		<div className="max-w-md mx-auto px-4 py-12">
			{onBack ? (
				<button
					onClick={onBack}
					className="flex items-center gap-2 text-neutral-500 hover:text-neutral-900 mb-6 font-sans text-sm"
				>
			...
			<div className="bg-white p-6 rounded-xl border border-neutral-200 shadow-modal text-center space-y-6">
				...
				<div>
					...
					<p className="font-sans text-sm text-neutral-500 mt-1">
						Masukkan PIN Keamanan Vendor untuk mengakses panel operasional
					</p>
				</div>
				...
				<Button
					...
					className="w-full font-quick font-semibold h-11"
				>
