...
import { RecipientFormData } from "@/lib/validators";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <Select
            ...
            onValueChange={(v) =>
              updateField("identityType", v as RecipientFormData["identityType"])
            }
          >
            <SelectTrigger>
          ...
          {errors.identityType && (
            <p className="text-xs font-sans text-c-red">{errors.identityType}</p>
          )}
        </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          {errors.identityNumber && (
            <p className="text-xs font-sans text-c-red">{errors.identityNumber}</p>
          )}
        </div>
      </div>
    </div>
