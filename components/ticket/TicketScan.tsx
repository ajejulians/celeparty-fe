        ...
        <CardContent className="p-6">
          ...
          {activeTab === "usb" && (
            <div className="py-12 space-y-6 text-center">
              ...
              <div>
                <h3 className="font-quick font-bold text-lg text-neutral-900">Menunggu Scanner...</h3>
                <p className="font-sans text-sm text-neutral-500 mt-2">
                  Pastikan scanner USB terhubung. Gunakan scanner untuk memindai barcode.
                </p>
              </div>
          ...
          {activeTab === "manual" && (
            <form onSubmit={handleManualSubmit} className="space-y-4 py-8">
              ...
              <Button type="submit" className="w-full bg-c-blue text-white font-quick font-semibold h-12">
                Verifikasi Tiket
              </Button>
            </form>
          )}
