    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="Contoh: Sewa Sound System 5000W" className="h-10" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} placeholder="Contoh: Jakarta" className="h-10" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex items-start gap-2">
                    ...
                    <label htmlFor="negotiable" className="font-sans text-sm text-neutral-700 cursor-pointer select-none">
                      Bisa Nego
                    </label>
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea {...field} rows={4} placeholder="Jelaskan detail spesifikasi produk/jasa Anda..." />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <FormField
              ...
              render={({ field }) => (
                <div className="flex items-center gap-2">
                  <FormControl>
                    <Checkbox checked={field.value} onCheckedChange={field.onChange} id="shipping" />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <div className="flex items-center gap-2">
                  <FormControl>
                    <Checkbox checked={field.value} onCheckedChange={field.onChange} id="setup" />
                  </FormControl>
            ...
            {fields.map((field, index) => (
              <div key={field.id} className="grid grid-cols-1 sm:grid-cols-12 gap-3 items-end bg-neutral-50 p-3 sm:p-4 rounded-lg border border-neutral-100">
                <div className="sm:col-span-4 space-y-1">
                  <p className="font-sans text-xs font-medium text-neutral-400">Nama Varian</p>
                  <Input {...form.register(`variants.${index}.name`)} placeholder="Contoh: Paket VIP" className="h-9 bg-white" />
                  {form.formState.errors.variants?.[index]?.name && (
                    <p className="text-[10px] text-c-red font-sans">{form.formState.errors.variants[index]?.name?.message}</p>
                  )}
                </div>

                <div className="sm:col-span-3 space-y-1">
                  <p className="font-sans text-xs font-medium text-neutral-400">Harga (Rp)</p>
                  <Input type="number" {...form.register(`variants.${index}.price`)} placeholder="0" className="h-9 bg-white" />
                  {form.formState.errors.variants?.[index]?.price && (
                    <p className="text-[10px] text-c-red font-sans">{form.formState.errors.variants[index]?.price?.message}</p>
                  )}
                </div>

                <div className="sm:col-span-2 space-y-1">
                  <p className="font-sans text-xs font-medium text-neutral-400">Kuota</p>
                  <Input type="number" {...form.register(`variants.${index}.quota`)} placeholder="1" className="h-9 bg-white" />
                  {form.formState.errors.variants?.[index]?.quota && (
                    <p className="text-[10px] text-c-red font-sans">{form.formState.errors.variants[index]?.quota?.message}</p>
                  )}
                </div>

                <div className="sm:col-span-2 space-y-1">
                  <p className="font-sans text-xs font-medium text-neutral-400 line-clamp-1">Batas Waktu</p>
                  <Input type="date" {...form.register(`variants.${index}.deadline`)} className="h-9 bg-white" />
                </div>
        ...
        <div className="flex justify-end gap-3">
          <Button type="button" variant="outline" className="font-quick font-semibold h-10 px-6" onClick={() => router.push("/user/vendor/products")}>Batal</Button>
          <Button type="submit" disabled={form.formState.isSubmitting} className="font-quick font-semibold h-10 px-6 bg-c-blue text-white hover:brightness-95">
