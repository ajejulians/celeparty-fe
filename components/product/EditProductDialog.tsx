...
export function EditProductDialog({ open, onOpenChange }: EditProductDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent key={editingProduct?.slug} className="w-xl max-w-lg md:max-w-xl lg:max-w-2xl p-4 gap-0 flex flex-col max-h-[90dvh]">
        ...
        <Form {...form}>
          <form id="edit-product-form" onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-1 min-h-0 overflow-hidden">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                  ...
                  {[1, 2, 3, 4].map((i) => (
                    ...
                    >
                      ...
                      <span className="text-[9px] text-neutral-400 font-sans mt-0.5">Tambah</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Nama Produk <span className="text-red-500 font-bold">*</span></FormLabel>
                        <FormControl>
                ...
                <div>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Kategori <span className="text-red-500 font-bold">*</span></FormLabel>
                ...
                <div>
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Kota <span className="text-red-500 font-bold">*</span></FormLabel>
                        <Select value={field.value} onValueChange={field.onChange}>
                          <FormControl>
                            <SelectTrigger>
                ...
                <div className="md:col-span-2 grid grid-cols-2 gap-3">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Harga Sewa (Rp) <span className="text-red-500 font-bold">*</span></FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            placeholder="0"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Unit Sewa <span className="text-red-500 font-bold">*</span></FormLabel>
                        <Select value={field.value} onValueChange={field.onChange}>
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue />
                ...
                <div className="md:col-span-2 grid grid-cols-2 gap-3">
                  <div className="flex flex-col space-y-1.5">
                    ...
                    <div className="h-10 px-3 py-2 bg-neutral-100 border border-neutral-200 rounded-md flex items-center justify-between text-sm text-neutral-400 cursor-not-allowed select-none">
                      ...
                      <span className="text-[10px] text-neutral-400 italic">Terkunci (Dinamis)</span>
                    </div>
                  </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Total Unit <span className="text-red-500 font-bold">*</span></FormLabel>
                        <FormControl>
                          <Input
                            type="number"
                            min={0}
                        ...
                        {editingProduct && (
                          <FormDescription className="text-xs text-neutral-400 mt-0.5 font-normal">
                            {dynamicStock} dari {currentTotal} unit tersedia ({rentedUnits} unit sedang disewa)
                          </FormDescription>
                        )}
                        <FormMessage />
                      </FormItem>
                ...
                <div className="md:col-span-2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Status <span className="text-red-500 font-bold">*</span></FormLabel>
                        <Select value={field.value} onValueChange={field.onChange}>
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue />
                ...
                <div className="md:col-span-2">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Deskripsi <span className="text-neutral-400 font-normal text-xs">(Opsional)</span></FormLabel>
                        <FormControl>
                          <Textarea {...field} rows={3} placeholder="Deskripsi produk..." className="min-h-[100px] resize-y" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
