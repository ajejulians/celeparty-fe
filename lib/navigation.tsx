...
const ADMIN_NAV_ITEMS: NavItem[] = [
	...
	{
		href: "/user/admin/moderation",
		icon: <CheckCircle className="w-5 h-5" />,
		label: "Moderasi",
	},
	{
		href: "/user/admin/quotation",
...
const VENDOR_NAV_ITEMS: NavItem[] = [
	...
	{
		href: "/user/vendor/monitoring",
		icon: <Activity className="w-5 h-5" />,
		label: "Monitoring",
	},
	{
		href: "/user/vendor/wallet",
